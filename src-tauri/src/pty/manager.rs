...
/// Key for the frontend's main JSON settings block in `app_settings`. Read here only for the default-shell
/// keys below; agent executable paths are resolved in `agent::executable`.
